...
{               ?>
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
                <span class="menu-title">Academics Details</span>
                <i class="icon-layers menu-icon"></i>
              </a>
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="add-class.php">Add academics</a></li>
                  <li class="nav-item"> <a class="nav-link" href="manage-class.php">Manage academics</a></li>
                  <li class="nav-item"> <a class="nav-link" href="add-academics.php">Manage academics</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
